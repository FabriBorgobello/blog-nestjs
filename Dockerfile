...
# Install app dependencies using yarn install (frozen-lockfile flag prevents updating the lockfile)
...
# Healthcheck to ensure the container is healthy (uses the /health endpoint)
